---
title: 'Homework 3: Some of my best friends are Zombies :0'
author: "Jimmy Erkens"
date: "`r Sys.Date()`"
output: 
...
![Deadites are in the same genus no? Mommie's with the maggots now!](https://media.tenor.com/_NcBuTYrTmUAAAAC/mommys-with-the-maggots-with-the-maggots-now.gif)
...
```
# COMMENT: I like the way you found the population variance. It is much cleaner and more efficient than how I approached it (by using the formula and multiple lines of code). It is very digestable and looks great!
## Question 2
...
```
# COMMENT: I like the way you found confidence intervals. I used alpha = 0.5 in mine, I'm a little unsure of the 0.975 number and what it is signifying, maybe you could explain how/why you included it. I think the way this is set up is very concise and I like your method a lot.
...
```
# COMMENT: This is also different from how I approached this task, but I think it is very efficient and easy to understand. I think overall your code loos great and I really liked the concise ways you approached each problem, I felt like I learned a lot from looking at your code.
